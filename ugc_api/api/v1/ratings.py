...
@router.put("/{film_id}", response_model=RatingPutResponse, status_code=HTTPStatus.OK)
...
@router.get("/{film_id}", response_model=RatingGetResponse, status_code=HTTPStatus.OK)
async def get_rating(
    ...
    return RatingGetResponse(film_id=str(film_id), user_id=user_id, score=score)
