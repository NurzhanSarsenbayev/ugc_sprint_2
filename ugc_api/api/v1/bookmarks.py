...
from ugc_api.dependencies import get_bookmarks_service, user_id_header
...
@router.put("/{film_id}", response_model=BookmarkPutResponse, status_code=HTTPStatus.OK)
...
@router.delete("/{film_id}", response_model=BookmarkDeleteResponse, status_code=HTTPStatus.OK)
...
@router.get("", response_model=BookmarkListResponse, status_code=HTTPStatus.OK)
